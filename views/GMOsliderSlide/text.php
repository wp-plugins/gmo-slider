...
<div class="gmoslider_slide gmoslider_slide_text" style="<?php echo strlen($color) > 0 ? 'background-color: ' . $color . ';' : '' ?>">
	<?php if(strlen($title) > 0): ?>
	<<?php echo $titleElementTag; ?> class="gmoslider_title" style="<?php echo strlen($textColor) > 0 ? 'color: ' . $textColor . ';' : ''; ?>">
		<?php echo $anchorTag; ?>
			<?php echo $title; ?>
	...
	<<?php echo $descriptionElementTag; ?> class="gmoslider_description" style="<?php echo strlen($textColor) > 0 ? 'color: ' . $textColor . ';' : ''; ?>">
		<?php echo $anchorTag; ?>
	...
	<a <?php echo $anchorTagAttributes ?> class="gmoslider_background_anchor"></a>
</div>